...
public class MemUsageFastUtilObjIntCustom {

    public static void main(String[] args) {

        int numb = 10000000;
        Object2IntOpenCustomHashMap<byte[]> m_map = new Object2IntOpenCustomHashMap<>(FastUtilObj2IntCustomTest.deviceIdHashing);
